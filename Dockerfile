...
RUN true
COPY --from=builder /usr/lib/aarch64-linux-gnu/libsndfile.so* /usr/lib/aarch64-linux-gnu/
RUN true
COPY --from=builder /usr/lib/aarch64-linux-gnu/libFLAC.so* /usr/lib/aarch64-linux-gnu/
RUN true
COPY --from=builder /usr/lib/aarch64-linux-gnu/libvorbis.so* /usr/lib/aarch64-linux-gnu/
RUN true
COPY --from=builder /usr/lib/aarch64-linux-gnu/libvorbisenc.so* /usr/lib/aarch64-linux-gnu/
RUN true
COPY --from=builder /usr/lib/aarch64-linux-gnu/libopus.so* /usr/lib/aarch64-linux-gnu/
RUN true
COPY --from=builder /usr/lib/aarch64-linux-gnu/libogg.so* /usr/lib/aarch64-linux-gnu/
RUN true
COPY --from=builder /usr/lib/aarch64-linux-gnu/libmpg123.so* /usr/lib/aarch64-linux-gnu/
RUN true
COPY --from=builder /usr/lib/aarch64-linux-gnu/libmp3lame.so* /usr/lib/aarch64-linux-gnu/
RUN true
